...
- "What I did today" journal entries with editable dates and gentle auto-save feedback.
...
Use the **Export data** button at the bottom of the interface to download `daily_summary_YYYY-MM-DD.json`. This file contains your journal and TODOs for safe keeping or import elsewhere.
